...
# This is very concise and slick

# This function finds the number of ways that items can be used to make a total
...
# This function finds the number of ways that parcels can be put together
@lru_cache(maxsize=None)
